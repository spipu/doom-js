...
class DoomGunTriggers {
    ...
    /**
     * @param {object[]} lines [{x1, z1, x2, z2, once, used, targets, reverseTargets, cycleVariant, stageRules}]
     */
    constructor(lines) {
        this._lines = lines;
    }
    ...
    _fire(line) {
        ...
        DoomTriggerTargets.fire(line.targets, line.reverseTargets ?? null, line.cycleVariant, line.stageRules ?? null);
    }
