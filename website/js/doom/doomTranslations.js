...
class DoomTranslations {
    static get CATALOG() {
        return {
            ...
            'menu.wad.empty':          {fr: 'Aucun jeu pour l\'instant',              en: 'No game yet'},
            'menu.wad.emptyHint':      {fr: 'Pour jouer, il faut d\'abord ajouter un jeu.',
                                        en: 'To play, you first need to add a game.'},
            'menu.wad.emptyHintHelp':  {fr: 'Vous n\'en avez pas ?',
                                        en: 'Don\'t have one?'},
            'menu.wad.emptyHintSteps': {fr: 'Cliquez sur « {help} » : tout y est expliqué pas à pas.',
            ...
            'help.guide':              {fr: 'Aide',                                  en: 'Help'},
            'help.guide.wad':          {fr: 'Pour jouer, il faut un fichier de jeu, appelé un WAD : c\'est lui qui contient les niveaux, les monstres, les images et les sons. Spipu-Doom n\'en fournit aucun — vous en apportez un, et il le fait tourner.',
            ...
            'help.guide.freedoom':     {fr: 'Le plus simple est Freedoom : un jeu complet, gratuit et légal, dans le style de Doom. Téléchargez-le sur le site ci-dessous, ouvrez le fichier ZIP obtenu, et vous y trouverez « freedoom1.wad ». Revenez ici, cliquez sur « {addFile} » et choisissez ce fichier.',
            ...
            'help.guide.own':          {fr: 'Si vous possédez déjà Doom, Doom II, Heretic ou Hexen, leur fichier WAD fonctionne exactement pareil. « {addUrl} » sert à aller chercher un fichier directement sur une adresse internet, quand le site qui l\'héberge le permet.',
            ...
            'help.guide.install':      {fr: 'Sur téléphone ou tablette, installez Spipu-Doom pour jouer en plein écran, sans la barre du navigateur : sur iPhone et iPad, avec Safari, touchez le bouton Partager puis « Sur l\'écran d\'accueil » ; sur Android, avec Chrome, ouvrez le menu ⋮ (les trois points) puis « Installer l\'application ». Une icône apparaît, et le jeu fonctionne ensuite même sans connexion internet.',
            ...
            'help.guide.controls':     {fr: 'Jouez au clavier et à la souris, à la manette, ou avec les commandes tactiles qui s\'affichent à l\'écran : Spipu-Doom reconnaît tout seul ce que vous utilisez. Chaque touche peut être changée dans les options, une fois un jeu choisi.',
            ...
            'help.about.source':       {fr: 'Code source du projet :',                en: 'Project source code:'},
            'help.about.licence':      {fr: 'Licence MIT — à l\'exception des graphismes de decals d\'impact et des textes de fin de chapitre, repris d\'UZDoom sous licence GPL v3, et du synthétiseur musical libADLMIDI, embarqué sous licence LGPL v3.',
