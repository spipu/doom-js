...
| ESC | Button 9 | Pause menu (resume / options / leave the level) over the frozen game (not remappable — in game the browser consumes `ESC` to release the mouse, and that release is the pause signal) |
...
│   │   │   ├── menuPauseModal.js      Pause modal over the frozen game (resume / options / leave the level)
